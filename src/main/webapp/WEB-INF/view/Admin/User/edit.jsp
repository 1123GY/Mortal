...
<rapid:override name="content">
    ...
    <form class="layui-form" action="/admin/user/editSubmit" id="userForm"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <div class="layui-upload">
                    ...
                    <input type="hidden" name="userPhoto" id="userPhoto" value="${userCustom.userPhoto}">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="userPassword" value="${userCustom.userPassword}" id="userPassword" required
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="email" name="userQQ" value="${userCustom.userQQ}" id="userQQ" required
                       lay-verify="userQQ"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="userRole" value="1" title="正常" <c:if test="${userCustom.userRole==1}">checked</c:if>>
                <input type="radio" name="userRole" value="0" title="禁用" <c:if test="${userCustom.userRole==0}">checked</c:if>>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
